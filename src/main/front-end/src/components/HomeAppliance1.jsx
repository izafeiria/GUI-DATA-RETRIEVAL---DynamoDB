...
const HomeAppliance1 = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        navigate('/homeApplianceExistence/Results', {state: {attribute : attribute ,value : value,appliance: appliance,exist: exist, filename : "homeApplianceExist", service : "HM1"}})
           ...
           <div><ButtonForFirstPage /></div>
              <div className="d-flex justify-content-center">
                 <form className="col-sm-4" style={{marginTop: "0px", marginBottom: "200px", padding: "25px", borderRadius: "10px",backgroundColor: "rgb(27, 110, 148, 0.3)"}} onSubmit={handleSubmit} >
                        ...
                        <br/>
                        <h4 className="text-center" style={{marginBottom: "20px"}}  >Appliance</h4>
                        ...
                        <div id = "exist" hidden onChange={Value}>
